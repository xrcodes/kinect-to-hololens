                                                         ...
                                                         gsl::span<const std::byte> depth_encoder_frame)
{
    ...
    memcpy(message.data() + cursor, depth_encoder_frame.data(), depth_encoder_frame.size());
...
FecSenderPacketData parse_fec_sender_packet_bytes(gsl::span<const std::byte> packet_bytes)
{
    ...
    fec_sender_packet_data.message_data.resize(packet_bytes.size() - cursor);
    memcpy(fec_sender_packet_data.message_data.data(), &packet_bytes[cursor], fec_sender_packet_data.message_data.size());
