...
extern "C" TextureGroup* UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API texture_group_reset()
{
...
extern "C" UNITY_INTERFACE_EXPORT void UNITY_INTERFACE_API texture_group_set_ffmpeg_frame(kh::FFmpegFrame* ffmpeg_frame)
{
    texture_group_->ffmpeg_frame = std::move(*ffmpeg_frame);
}

extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API texture_group_set_depth_pixels(std::vector<short>* depth_pixels)
{
