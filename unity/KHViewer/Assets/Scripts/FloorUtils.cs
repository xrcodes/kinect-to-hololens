...
{
    public static void ConvertFloorFromVideoSenderMessageDataToPositionAndRotation(float[] floor, out Vector3 position, out Quaternion rotation)
    {
        ...
        Plane floorPacketPlane = new Plane(new Vector3(floor[0], -floor[1], floor[2]), floor[3]);
        //Vector3 upVector = new Vector3(floorSenderPacketData.a, -floorSenderPacketData.b, floorSenderPacketData.c);
